...
export function SubmitButton({ isDisabled, isPressed }: SubmitButtonProps) {
  return (
    <motion.button
      disabled={isDisabled}
      type="submit"
      className="z-20 inline-flex items-center justify-center h-8 w-8 rounded-full disabled:bg-gray-100 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 dark:disabled:bg-zinc-800 transition duration-200 animate-[gradient_7s_ease_infinite] hover:shadow-lg backdrop-blur-sm dark:backdrop-blur-md pointer-events-auto"
      style={{
